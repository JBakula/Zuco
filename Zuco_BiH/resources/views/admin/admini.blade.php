    ...
    <div class="container">
      <div class="d-flex flex-row-reverse button--choose--category">
        <div class="bd-highlight mx-3">
          <a class="button--choose--btn" href="{{route('adminCreate')}}">Dodaj admina</a>
          {{-- <button class="button--choose--btn">Odobreni</a> --}}
        </div>
      </div>
         ...
         @foreach ($data as $item)
          <tr>
            ...
            <td class="table--pohvale__buttons text-center">
              <a href="{{route('adminEdit',$item->id)}}" class="button--choose--btn">
                <svg
              ...
              <form method="POST" action="{{ route('adminDelete', $item->id) }}">
                @csrf
