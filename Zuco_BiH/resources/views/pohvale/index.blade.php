      ...
      <div class="container">
        <div class="d-flex flex-row-reverse button--choose--category">
          <div class="bd-highlight mx-3">
            <a href="{{route('odobrenePohvale')}}" class="button--choose--btn">Odobrene</a>
          </div>
          <div class="bd-highlight mx-3">
            <a href="{{route('neodobrenePohvale')}}" class="button--choose--btn">Neodobrene</a>
          </div>
          ...
          <tbody class="table--pohvale__body">
            ...
            <tr>
              ...
              <td class="table--pohvale__buttons text-center">
                <a href="{{route('pohvalaEdit',$item->id)}}"  class="button--choose--btn">
                  <svg
                ...
                <form method="POST" action="{{ route('pohvalaDelete', $item->id) }}">
                  @csrf
